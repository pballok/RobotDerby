...
SCENARIO("Neighbour coordinate calculation", "[Board]")
{
  GIVEN("an empty board") {
    ...
    THEN("all neighbours must be an invalid index") {
      REQUIRE(board.neighbour(0, Direction::North) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(0, Direction::East) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(0, Direction::South) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(0, Direction::West) == board.invalidPositionIndex());
    }
  }
  ...
  GIVEN("a 3 by 4 Board") {
    ...
    THEN("the north neighbour calculations must be correct") {
      REQUIRE(board.neighbour(0, Direction::North) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(1, Direction::North) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(2, Direction::North) == board.invalidPositionIndex());
      ...
      REQUIRE(board.neighbour(12, Direction::North) == board.invalidPositionIndex());
    }
    ...
    THEN("the east neighbour calculations must be correct") {
      ...
      REQUIRE(board.neighbour(2, Direction::East) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(3, Direction::East) == 4);
      REQUIRE(board.neighbour(4, Direction::East) == 5);
      REQUIRE(board.neighbour(5, Direction::East) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(6, Direction::East) == 7);
      REQUIRE(board.neighbour(7, Direction::East) == 8);
      REQUIRE(board.neighbour(8, Direction::East) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(9, Direction::East) == 10);
      REQUIRE(board.neighbour(10, Direction::East) == 11);
      REQUIRE(board.neighbour(11, Direction::East) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(12, Direction::East) == board.invalidPositionIndex());
    }
    ...
    THEN("the south neighbour calculations must be correct") {
      ...
      REQUIRE(board.neighbour(9, Direction::South) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(10, Direction::South) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(11, Direction::South) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(12, Direction::South) == board.invalidPositionIndex());
    }
    ...
    THEN("the west neighbour calculations must be correct") {
      ...
      REQUIRE(board.neighbour(3, Direction::West) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(4, Direction::West) == 3);
      REQUIRE(board.neighbour(5, Direction::West) == 4);
      REQUIRE(board.neighbour(6, Direction::West) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(7, Direction::West) == 6);
      REQUIRE(board.neighbour(8, Direction::West) == 7);
      REQUIRE(board.neighbour(9, Direction::West) == board.invalidPositionIndex());
      REQUIRE(board.neighbour(10, Direction::West) == 9);
      REQUIRE(board.neighbour(11, Direction::West) == 10);
      REQUIRE(board.neighbour(12, Direction::West) == board.invalidPositionIndex());
    }
  }
}
